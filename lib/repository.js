...
Repository.prototype.clone = function () {
  ...
  return new Promise(function (resolve, reject) {
    ...
    exec(quotewrap(commands.join(' && ')), function (err, stdout, stderr) {
      if (err) {
        reject();
        throw err;
      }
...
Repository.prototype.branch = function (name) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    exec(quotewrap(commands.join(' && ')), {cwd: self.path}, function (err, stdout, stderr) {
      if (err) {
        reject();
        throw err;
      }
